...
<div class="row mb-5 mt-5 d-flex justify-content-center">
    <div data-bs-toggle="modal" data-bs-target="#myModal0" class="col-md-2 col-12"  style="text-align: center;">
        <div style="color: black; border: none" class="card bg-light shadow rounded-3">
            <div class="mt-4 mb-3">
                <img class="card-img-top"
                     src="https://res.cloudinary.com/vinhphuvtv2/image/upload/v1666255383/Web_QLPM/Avatar/pie-chart_bgatev.png"
                     alt="Card image"
                     style="width:40%">
            </div>
            <h6 class="card-title">Tổng SL Bệnh Nhân</h6>
        </div>
    </div>
...
<div class="row mb-2 mt-2">
    <div class="col-md-9 col-12">
        <div style="text-align: center"class="">
            <!-- The Modal --> <!--TỔNG SỐ LƯỢNG BỆNH NHÂN-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">TỔNG SỐ LƯỢNG BỆNH NHÂN</h4> 
